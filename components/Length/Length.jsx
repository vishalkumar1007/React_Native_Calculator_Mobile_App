    ...
    return (
        <View style={[styles.main ,  {backgroundColor: colorMode==='black'?'black':'#f0f0f0'}]}>
            ...
            <View style={styles.LengthTop}>
                <View style={styles.LengthInputMain}>
                    <View style={styles.LengthInputHead}>
                    ...
                    <View style={styles.LengthInputContainer}>
                        <View style={styles.LengthInputTop}>
                        ...
                        <View style = {styles.LengthInputBottom}></View>
                    </View>
                </View>
            </View>
