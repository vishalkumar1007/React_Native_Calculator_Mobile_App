...
const Speed = ({colorMode, openComponent, closeComponentProp }) => {
    ...
    return (
        <View style={[styles.main ,  {backgroundColor: colorMode==='black'?'black':'#f0f0f0'}]}>
            ...
            <View style={styles.speedTop}>
                <View style={styles.speedInputMain}>
                    <View style={styles.speedInputHead}>
                    ...
                    <View style={styles.speedInputContainer}>
                        <View style={styles.speedInputTop}>
                        ...
                        <View style = {styles.speedInputBottom}></View>
                    </View>
                </View>
            </View>
