...
const Time = ({colorMode, openComponent, closeComponentProp }) => {
    ...
    return (
        <View style={[styles.main ,  {backgroundColor: colorMode==='black'?'black':'#f0f0f0'}]}>
            ...
            <View style={styles.timeTop}>
                <View style={styles.timeInputMain}>
                    <View style={styles.timeInputHead}>
                    ...
                    <View style={styles.timeInputContainer}>
                        <View style={styles.timeInputTop}>
                        ...
                        <View style = {styles.timeInputBottom}></View>
                    </View>
                </View>
            </View>
