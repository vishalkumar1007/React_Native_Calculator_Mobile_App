...
const Temperature = ({ colorMode, openComponent, closeComponentProp }) => {
    ...
    const [drop1Value, setDrop1Value] = useState('Year');
    const [drop1ValueUnit, setDrop1ValueUnit] = useState('yr');
    ...
    // .....................
    const [drop2Value , setDrop2Value] = useState('Year')
    const [drop2ValueUnit , setDrop2ValueUnit] = useState('yr')
    ...
    const AreaData = [['Year', 'yr'], ['Week', 'wk'], ['Day', 'd'], ['Hour', 'hr'], ['Minute', 'min'], ['Second', 's'], ['Millisecond', 'ms'], ['Microsecond', 'μs'], ['Picosecond', 'ps']]
    const Area2Data = [['Year', 'yr'], ['Week', 'wk'], ['Day', 'd'], ['Hour', 'hr'], ['Minute', 'min'], ['Second', 's'], ['Millisecond', 'ms'], ['Microsecond', 'μs'], ['Picosecond', 'ps']]
