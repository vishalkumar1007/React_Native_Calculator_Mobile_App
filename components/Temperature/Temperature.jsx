...
const Temperature = ({colorMode, openComponent, closeComponentProp }) => {
    ...
    useEffect(()=>{
        console.log('temperature : ',colorMode);
    },[colorMode])
    ...
    return (
        <View style={[styles.main ,  {backgroundColor: colorMode==='black'?'black':'#f0f0f0'}]}>
            ...
            <View style={styles.temperatureTop}>
                <View style={styles.temperatureInputMain}>
                    <View style={styles.temperatureInputHead}>
                    ...
                    <View style={styles.temperatureInputContainer}>
                        <View style={styles.temperatureInputTop}>
                        ...
                        <View style = {styles.temperatureInputBottom}></View>
                    </View>
                </View>
            </View>
            <View style={styles.temperatureBottom}>
