...
const Temperature = ({ colorMode, openComponent, closeComponentProp }) => {
    ...
    const [drop1Value, setDrop1Value] = useState('Celsius');
    ...
    // .....................
    const [drop2Value , setDrop2Value] = useState('Celsius')
    ...
    const AreaData = [['Celsius', 'C'], ['Fahrenheit', 'F'], ['Kelvin', 'K']]
    const Area2Data = [['Celsius', 'C'], ['Fahrenheit', 'F'], ['Kelvin', 'K']]
