...
const Discount = ({colorMode, openComponent, closeComponentProp }) => {
    ...
    useEffect(()=>{
        console.log('Discount : ',colorMode);
    },[colorMode])
    ...
    return (
        <View style={[styles.main ,  {backgroundColor: colorMode==='black'?'black':'#f0f0f0'}]}>
            ...
            <View style={styles.DiscountTop}>
                <View style={styles.DiscountInputMain}>
                    <View style={styles.DiscountInputHead}>
                    ...
                    <View style={styles.DiscountInputContainer}>
                        <View style={styles.DiscountInputTop}>
                        ...
                        <View style = {styles.DiscountInputBottom}></View>
                    </View>
                </View>
            </View>
