...
const Data = ({ colorMode, openComponent, closeComponentProp }) => {
    ...
    const [drop1Value, setDrop1Value] = useState('Byte');
    const [drop1ValueUnit, setDrop1ValueUnit] = useState('B');
    ...
    // .....................
    const [drop2Value , setDrop2Value] = useState('Byte')
    const [drop2ValueUnit , setDrop2ValueUnit] = useState('B')
    ...
    const AreaData = [['Byte', 'B'], ['Kilobyte', 'KB'], ['Megabyte', 'MB'], ['Gigabyte', 'GB'], ['Terabyte', 'TB'], ['Petabyte', 'PB']]
    const Area2Data = [['Byte', 'B'], ['Kilobyte', 'KB'], ['Megabyte', 'MB'], ['Gigabyte', 'GB'], ['Terabyte', 'TB'], ['Petabyte', 'PB']]
