...
const Currency = ({colorMode, openComponent, closeComponentProp }) => {
    ...
    useEffect(()=>{
        console.log('currency : ',colorMode);
    },[colorMode])
    ...
    return (
        <View style={[styles.main ,  {backgroundColor: colorMode==='black'?'black':'#f0f0f0'}]}>
            ...
            <View style={styles.currencyTop}>
                <View style={styles.currencyInputMain}>
                    <View style={styles.currencyInputHead}>
                    ...
                    <View style={styles.currencyInputContainer}>
                        <View style={styles.currencyInputTop}>
                        ...
                        <View style = {styles.currencyInputBottom}></View>
                    </View>
                </View>
            </View>
